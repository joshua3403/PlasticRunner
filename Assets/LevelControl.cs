...
public class LevelData
{
    ...
    public class LevelControl : MonoBehaviour
    {
        ...
        private void update_level(ref CreationInfo current, CreationInfo previous, float passage_time)        // 새 인수 passage_time으로 플레이 경과 시간을 받는다.
        {
        // 레벨 1~레벨 5를 반복한다.
    ...
    public void loadLevelData(TextAsset level_data_text)
    {
        ...
        foreach(var line in lines)
        {
            ...
            foreach(var word in words)
            {
                ...
                // n 값을 0, 1, 2,...7로 변화시켜 감으로써 8개의 항목을 처리한다.
